...
def build_entrance_links(nodes, members):
    ...
    return ("-- Generated by tools/regen_maps.py -- do not edit.\n"
            ...
            "-- section hosts and the map it stands on. scripts/entrance_items\n"
            "-- builds the badge items from this, and reads the code rather than\n"
            "-- rebuilding it -- overworld_pins.entrance_code is the one place a\n"
            "-- code is minted.\n"
            "ENTRANCE_PINS = {\n" + "\n".join(pins) + "\n}\n")
